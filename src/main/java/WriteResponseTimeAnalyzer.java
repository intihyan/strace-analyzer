...
public class WriteResponseTimeAnalyzer {
    ...
    private void createScatterPlot() {
        ...
        for (Map.Entry<Integer, List<SyscallEntry>> e : writeTbl.entrySet()) {
            ...
            System.err.format(" average write response time for file descriptor %d is %f ; total number: %d\n", e.getKey(), total_time * 1000/ e.getValue().size(), e.getValue().size());
